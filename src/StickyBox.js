/*
    Temporarily use this instead of react-sticky-box until the author
    implements https://github.com/codecks-io/react-sticky-box/pull/18
*/
...
export default class StickyBox extends React.Component {
    ...
    initial() {
        const { bottom, offsetTop, offsetBottom } = this.props;
        if (bottom) {
